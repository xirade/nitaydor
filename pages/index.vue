...
export default {
  data() {
    return {
      title: "נתאי דור - יועץ נדל''ן האיש שלך לבית חלומותיך",
      description:
        "התמחות בבתי מגורים, ניתוח סביבה קהילתית להתאמה אישית, אפיון והתאמה של הנכס בהתאם למיקומו ואומדנו ליווי אישי בתהליכי רכישה/ מכירה בבאר יעקב או בסביבה כל המידע לו זקוק נתאי דור יועץ הנדל''ן",
      structuredData: {
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: "og:url",
          property: "og:url",
          content: "http://nitaydor-nadlan.com/"
        },
        {
          hid: "robots",
          property: "robots",
